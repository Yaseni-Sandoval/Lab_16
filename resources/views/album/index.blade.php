            ...
            <div class="col-sm-6 col-md-4 col-12 pt-1 album-container" data-album="{{ $album->album_nombre }}">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('foto.index', ['album' => $album->album_id]) }}" class="btn btn-info">Ver Fotos</a>
                        <a href="{{ route('album.edit', ['album' => $album->album_id]) }}" class="btn btn-success">Editar</a>
